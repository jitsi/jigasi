...
LD_LIBRARY_PATH=$libs exec java --enable-native-access=ALL-UNNAMED -Xmx$JIGASI_MAX_MEMORY -Djdk.net.usePlainDatagramSocketImpl=true -Djava.awt.headless=true -Djava.library.path=$libs $LOGGING_CONFIG_PARAM $JAVA_SYS_PROPS -cp $cp $mainClass $@
