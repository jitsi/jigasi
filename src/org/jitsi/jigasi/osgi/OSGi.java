...
public class OSGi
{
    ...
    private static String[][] getBUNDLES()
    {
        ...
        String[][] bundles = {
            ...
            {
                "org/jitsi/jigasi/osgi/OSGiBundleActivator"
            },
            {
    ...
    private static void start()
    {
        ...
        configuration.put(
                ...
                Integer.toString(getBUNDLES().length));
        ...
        try
        {
            ...
            for (int startLevelMinus1 = 0;
                    startLevelMinus1 < getBUNDLES().length;
                    startLevelMinus1++)
            {
                int startLevel = startLevelMinus1 + 1;

                for (String location : getBUNDLES()[startLevelMinus1])
                {
