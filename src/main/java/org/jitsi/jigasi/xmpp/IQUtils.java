...
//        throws Exception
//    {
//        String xml = smackIQ.getChildElementXML().toString();
...
//
//        Jid from = smackIQ.getFrom();
//
//        if ((from != null) && (from.length() != 0))
//            iq.setFrom(new JID(from.toString()));
//        iq.setID(smackIQ.getStanzaId());
//
//        Jid to = smackIQ.getTo();
//
//        if ((to != null) && (to.length() != 0))
//            iq.setTo(new JID(to.toString()));
